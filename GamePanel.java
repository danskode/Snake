...
public class GamePanel extends JPanel implements ActionListener{
   ...
   public void checkHit(){
      // check if the head runs into the body ...
      for (int i = length ; i > 0 ; i--){
         if( x[0] == x[i] && y[0] == y[i] ){
            running = false;
         }
      }
      // check if head runs into a wall ... 
   ...
   public void gameOver(Graphics graphics){
      ...
      graphics.drawString("Nicoos første spil", (WIDTH - metrics.stringWidth("Nicoos første spil")) / 2, (HEIGHT / 3)*2 );
